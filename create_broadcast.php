...
if(!isset($_SESSION['CLIENT_ID']))
{
	...
	$_SESSION['CLIENT_SECRET'] = $_POST['key'];
	$_SESSION['CLIENT_NAME'] = $_POST['name'];
	$_SESSION['CLIENT_DATESTART'] = $_POST['datestart'];
	$_SESSION['CLIENT_DATEEND'] = $_POST['dateend'];
	$_SESSION['CLIENT_TYPE'] = $_POST['type'];
}	


$client = new Google_Client();
$OAUTH2_CLIENT_ID = $_SESSION['CLIENT_ID'];
$OAUTH2_CLIENT_SECRET = $_SESSION['CLIENT_SECRET'];
...
if ($client->getAccessToken()) {
  try {
    ...
    $broadcastSnippet->setTitle($_SESSION['CLIENT_NAME']);
    $broadcastSnippet->setScheduledStartTime($_SESSION['CLIENT_DATESTART']);
    $broadcastSnippet->setScheduledEndTime($_SESSION['CLIENT_DATEEND']);

    // Create an object for the liveBroadcast resource's status, and set the
    // broadcast's status to "private".
    $status = new Google_Service_YouTube_LiveBroadcastStatus();
	$type =$_SESSION['CLIENT_TYPE']; 
		if($type="Publica"){	
			$type="public";
		}
		if($type="Privada"){
    ...
    $streamSnippet->setTitle($name =$_SESSION['CLIENT_NAME']);
  ...
  $_SESSION[$tokenSessionKey] = $client->getAccessToken();
} elseif ($OAUTH2_CLIENT_ID == 'replace?') {
  $htmlBody = <<<END
